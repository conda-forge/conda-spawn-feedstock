...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-spawn-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-spawn-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-spawn
# for installing globally
pixi global install conda-spawn
```
...
It is possible to list all of the versions of `conda-spawn` available on your platform:
...
```
pixi search conda-spawn --channel conda-forge
```
